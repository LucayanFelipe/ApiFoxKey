...
namespace ApiLocadora.Services
{
    public class ClientePjService
    {
        ...
        {
            return await _context.clientepj.ToListAsync();
        }
        ...
        public async Task<ClientePj> GetOneById(int id)
        {
            try
            {
                return await _context.clientepj.SingleOrDefaultAsync(x => x.Id_cliente_pj == id);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ClientePj> Create(ClientePjDto item)
        {
            try
            {
                ...
                await _context.clientepj.AddAsync(novo);
        ...
        public async Task<ClientePj> Update(int id, ClientePjDto item)
        {
            try
            {
                var entidade = await _context.clientepj.FirstOrDefaultAsync(x => x.Id_cliente_pj == id);
        ...
        public async Task<ClientePj> Delete(int id)
        {
            try
            {
                ...
                _context.clientepj.Remove(entidade);
                await _context.SaveChangesAsync();
                return entidade;
            }
            catch (Exception ex)
        ...
        {
            return await _context.clientepj.AnyAsync(x => x.Id_cliente_pj == id);
        }
    }
}
