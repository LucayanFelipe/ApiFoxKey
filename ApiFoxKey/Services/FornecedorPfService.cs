...
namespace ApiLocadora.Services
{
    public class FornecedorPfService
    {
        ...
        {
            return await _context.fornecedorpf.ToListAsync();
        }

        public async Task<FornecedorPf> GetOneById(int id)
        {
            var item = await _context.fornecedorpf.SingleOrDefaultAsync(x => x.Id_fornecedor_pf == id);
        ...
        public async Task<FornecedorPf> Create(FornecedorPfDto dto)
        {
            ...
            await _context.fornecedorpf.AddAsync(novo);
        ...
        {
            var item = await _context.fornecedorpf.FindAsync(id);
        ...
        public async Task<FornecedorPf> Delete(int id)
        {
            ...
            _context.fornecedorpf.Remove(item);
            await _context.SaveChangesAsync();
            return item;
        }
        ...
        {
            return await _context.fornecedorpf.AnyAsync(x => x.Id_fornecedor_pf == id);
        }
    }
}
